import './style.css';
import DrawerPicture from './assets/drawers.jpg';
import ProfileMichelle from './assets/avatar-michelle.jpg';
    ...
    <div className="content-wrapper">
      <article className="card">
        <div className="card__img">
          <img src={DrawerPicture} alt="furniture" />
        </div>
        <div className="card__text-wrapper">
          ...
          <div className="card__footer-wrapper">
            <img src={ProfileMichelle} alt="author" className="author__img" />
